...
note_texture = pygame.image.load("note_texture.png")
plank_texture = pygame.image.load("plank_texture.png")
lock_texture = pygame.image.load("lock_texture.png")
puzzle_texture = pygame.image.load("puzzle_texture.png")
...
class Door(pygame.sprite.Sprite):
    def __init__(self, x, y, item="Key"):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("door_texture.png").convert_alpha(), (100, 200))
        self.rect = self.image.get_rect(topleft=(x, y))
        self.item = item
        self.visible = True
...
class PuzzleObject(pygame.sprite.Sprite):
    def __init__(self, x, y):
        ...
        self.image_index = 0
        self.image = pygame.transform.scale(pygame.image.load("puzzle_texture.png").convert_alpha(), (100, 100))
        self.rect = self.image.get_rect(topleft=(x, y))
        self.click_count = 0
...
class SlidingPlank(pygame.sprite.Sprite):
    def __init__(self, x, y):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("plank_texture.png").convert_alpha(), (100, 200))
        self.rect = self.image.get_rect(topleft=(x, y))
        self.visible = True
...
class Note(pygame.sprite.Sprite):
    def __init__(self, x, y, combination_lock):
        super().__init__()
        self.image = pygame.transform.scale(pygame.image.load("note_texture.png").convert_alpha(), (100, 100))
        self.rect = self.image.get_rect(topleft=(x, y))
        self.combination_lock = combination_lock
